...
reported to the project maintainer via a private [GitHub Security
Advisory](https://github.com/thalisantunes/mcp-mikrotik/security/advisories/new)
(the same private channel `SECURITY.md` describes for vulnerability
reports) or by opening a issue and asking to be contacted privately. All
